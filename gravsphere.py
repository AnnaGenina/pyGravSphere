...
def GetLikeBinAnisSphVSPfunc(*args):
  return _gravsphere.GetLikeBinAnisSphVSPfunc(*args)
GetLikeBinAnisSphVSPfunc = _gravsphere.GetLikeBinAnisSphVSPfunc

def GetLikeBinAnisSphVSPPowerLawfunc(*args):
  return _gravsphere.GetLikeBinAnisSphVSPPowerLawfunc(*args)
GetLikeBinAnisSphVSPPowerLawfunc = _gravsphere.GetLikeBinAnisSphVSPPowerLawfunc

def PowerLawFitfunc(*args):
  return _gravsphere.PowerLawFitfunc(*args)
PowerLawFitfunc = _gravsphere.PowerLawFitfunc

def ZhaoFitfunc(*args):
  return _gravsphere.ZhaoFitfunc(*args)
